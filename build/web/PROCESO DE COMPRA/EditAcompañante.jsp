...
<html>
    ...
    <body>
        <%
            ...
            ps = con.prepareStatement("select idPersonas,Nombres,Ape_Paterno,Ape_Materno,Fecha_Nacimiento,DNI,idPasaje,a.idAsiento,a.estado from personas p inner join asiento a on p.idAsiento=a.idAsiento where p.idPersonas=" + id);
            rs = ps.executeQuery();
        ...
        <div class="container">
            ...
            <hr>
            <form action="" method="post" class="form-control" style="width:500px;height:670px">
                Id:
                ...
                Pasaje:
                <input type="text" name="txtPasa" required class="form-control" value="<%= rs.getString("idPasaje")%>"/>
                Asiento:
