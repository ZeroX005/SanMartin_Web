...
<html>
    ...
    <body>
        <%
            ...
            ps = con.prepareStatement("select idCliente,Nombres,Ape_Paterno,Ape_Materno,Fecha_Nacimiento,DNI,Email,Celular,Nacionalidad,a.estado,a.idAsiento from cliente c inner join asiento a on c.idAsiento=a.idAsiento where idCliente=" + id);
            rs = ps.executeQuery();
        ...
        <div class="container">
            ...
            <hr>
            <div class="costado">
                <form action="" method="post" class="form-control" style="width:500px;height:710px">
                    Id:
                    <input type="text" name="txtId" readonly class="form-control" value="<%= rs.getInt("idCliente")%>"/>
                    Nombres:
                    ...
                    Email:
                    <input type="email" name="txtEmail" required class="form-control" value="<%= rs.getString("Email")%>"/>
                    Celular:
                    <input type="text" name="txtCel" minlength="9" maxlength="9"  required class="form-control" value="<%= rs.getInt("Celular")%>"/>
                    Nacionalidad:
                    <input type="text" name="txtNac" required class="form-control" value="<%= rs.getString("Nacionalidad")%>"/>
                    Asiento:
...
<%
    String idef, nombre, paterno, materno, fecha, dni, email, celular, nacionalidad, asiento;
    ...
    if (idef != null && nombre != null && paterno != null && materno != null && fecha != null && dni != null && email != null && celular != null && nacionalidad != null && asiento != null) {
        ps = con.prepareStatement("update cliente set idCliente='" + idef + "',Nombres='" + nombre + "',Ape_Paterno='" + paterno + "',Ape_Materno='" + materno + "',Fecha_Nacimiento='" + fecha + "',DNI='" + dni + "',Email='" + email + "',Celular='" + celular + "',Nacionalidad='" + nacionalidad + "',idAsiento='" + asiento + "' where idCliente=" + idef);
        ps.executeUpdate();
