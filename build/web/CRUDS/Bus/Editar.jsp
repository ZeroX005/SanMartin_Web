...
<html>
    ...
    <body>
        <%
            ...
            ps = con.prepareStatement("select * from bus where idBus=" + id);
            rs = ps.executeQuery();
            while (rs.next()) {
        %>
        <div class="menu">
        ...
        <div class="container">
            ...
            <form action="" method="post" class="form-control" style="width:500px;height:310px">
                Id:
                <input type="text" name="txtId" readonly class="form-control" value="<%= rs.getInt("idBus")%>"/>
                Nombre Bus:
                <input type="text" name="txtNom" class="form-control" value="<%= rs.getString("Nom_Bus")%>"/>
                <br>
...
<%
    ...
    if (idef != null && nombre != null) {
        ps = con.prepareStatement("update bus set idBus='" + idef + "',Nom_bus='" + nombre + "' where idBus=" + idef);
        ps.executeUpdate();
