...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <hr>
            <a class="btn btn-success btn-lg" href="Agregar.jsp">Nueva Ciudad</a>
            <table class="table table-bordered">
                ...
                %>
                <tr>
                    <td class="text-center"><%= rs.getInt("idCiudad")%></td>
                    <td class="text-center"><%= rs.getString("Nombre_Ciudad")%></td>

                    <td class="text-center">
                        <a href="Editar.jsp?id=<%= rs.getInt("idCiudad")%>" class="btn btn-warning btn-sm">Editar</a>
                        <a href="Delete.jsp?id=<%= rs.getInt("idCiudad")%>" class="btn btn-danger btn-sm">Eliminar</a>
                    </td>
                </tr>
                <% }%>
            </table>
