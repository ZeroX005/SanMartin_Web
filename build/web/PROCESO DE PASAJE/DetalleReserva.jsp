        ...
        <div class="container">
            ...
            <table class="table-sm table-bordered" style="width: 100% !important">
                ...
                <tr>
                    ...
                    <td class="text-center"><a href="FiltroListado.jsp?id=<%= rs.getInt("idCliente")%>&ic=<%=rs.getInt("idPasaje")%>&ir=<%=rs.getInt("idReserva")%>" class="btn btn-success btn-sm">Ver</a></td>
