...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <h1>Acompañantes</h1>    
            <hr>
            <a href="../PROCESO DE PASAJE/DetalleReserva.jsp" class="btn btn-primary">Regresar</a>
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="EditAcompañante.jsp?id=<%= rs.getInt("idPersonas")%>" class="btn btn-warning btn-sm">Editar</a>
                        <a href="ElimAcompañante.jsp?id=<%= rs.getInt("Cod_Asiento")%>" class="btn btn-danger btn-sm">Eliminar</a>
                    </td>
                </tr>
                <% }%>
            </table>
