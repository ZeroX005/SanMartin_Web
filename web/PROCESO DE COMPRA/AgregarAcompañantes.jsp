    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="" method="post" class="form-control" style="width:500px;height:650px">
                ...
                <a href="DetalleReserva.jsp">Regresar</a>
                <%}%>
...
<%
    ...
    String nombre, paterno, materno, fecha, dni, pasaje, asiento;
    ...
    if (nombre != null && paterno != null && materno != null && fecha != null && dni != null && pasaje != null) {
        cs = con.prepareCall("{CALL SP_PERSONA_ASIENTO('" + nombre + "','" + paterno + "','" + materno + "','" + fecha + "','" + dni + "','" + pasaje + "','" + asiento + "','" + ic + "')}");
        cs.executeUpdate();
        response.sendRedirect("DetalleReserva.jsp");
    }
