        ...
        <div class="container">
            ...
            <div class="costado">
                <form action="" method="post" class="form-control" style="width:500px;height:700px">
                    ...
                    Id Pasaje:
                    <%while (rs.next()) {%>
                    <input type="text" name="txtPasa" readonly required class="form-control" value="<%=ic%>"/>
                    Ruta:
...
<%
    ...
    if (nombre != null && paterno != null && materno != null && fecha != null && dni != null && pasaje != null) {
        cs = con.prepareCall("{CALL SP_PERSONA_ASIENTO('" + nombre + "','" + paterno + "','" + materno + "','" + fecha + "','" + dni + "','" + pasaje + "','" + asiento + "','" + id + "')}");
        cs.executeUpdate();
