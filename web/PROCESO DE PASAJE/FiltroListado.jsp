...
<html>
    ...
    <body>
        ...
        <div class="container">
            <br>
            <h1>Acompañantes</h1>
            <a href="../PROCESO DE PASAJE/DetalleReserva.jsp">Regresar</a>
            <hr>
            <a href="AgregarAcompañantes.jsp?id=<%=id%>&ic=<%=ic%>&ir=<%=ir%>" class="btn btn-success btn-lg" style="margin-bottom: 20px">Agregar Personas</a>
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a href="EditAcompañante.jsp?ip=<%= rs.getInt("idPersonas")%>&ir=<%=ir%>&ic=<%=ic%>&id=<%=id%>" class="btn btn-warning btn-sm" style="margin-bottom:10px;width:66px">Editar</a>
                        <a href="ElimAcompañante.jsp?ia=<%= rs.getInt("Cod_Asiento")%>&ir=<%=ir%>&ic=<%=ic%>&id=<%=id%>" class="btn btn-danger btn-sm">Eliminar</a>
                    </td>
                </tr>
                <% }%>
            </table>
